...
class DHTAsyncServer(asyncio.Protocol):
	...
	def send_data(self, data):
		...
		if server2 is None or not client.connected:
			protocol, server2 = yield from loop.create_connection(lambda: DHTAsyncClient("messagetoother server",loop), '127.0.0.1',1338)
